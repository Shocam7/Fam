...
// verification/render_feed.tsx
var import_react = __toESM(require_react());
var import_server = __toESM(require_server_node());
function Sidebar() {
  return /* @__PURE__ */ import_react.default.createElement("aside", { className: "fixed left-0 top-0 h-screen w-64 border-r bg-white hidden md:flex flex-col" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "p-6" }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "text-2xl font-bold tracking-tight text-indigo-600" }, "FAM")), /* @__PURE__ */ import_react.default.createElement("nav", { className: "flex-1 px-4 space-y-2" }, /* @__PURE__ */ import_react.default.createElement("a", { href: "#", className: "flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" }, "My Feed"), /* @__PURE__ */ import_react.default.createElement("a", { href: "#", className: "flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" }, "Discover People"), /* @__PURE__ */ import_react.default.createElement("a", { href: "#", className: "flex items-center gap-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors" }, "My Fams")));
}
function FeedItem({ author, content }) {
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "bg-white p-6 rounded-lg shadow mb-4" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex justify-between items-start mb-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "w-10 h-10 bg-indigo-100 rounded-full flex items-center justify-center font-bold text-indigo-700" }, author[0]), /* @__PURE__ */ import_react.default.createElement("div", null, /* @__PURE__ */ import_react.default.createElement("div", { className: "font-bold text-gray-900" }, author), /* @__PURE__ */ import_react.default.createElement("div", { className: "text-xs text-gray-500" }, "Just now")))), /* @__PURE__ */ import_react.default.createElement("p", { className: "text-gray-800 text-lg" }, content));
}
function Page() {
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "flex min-h-screen bg-gray-50 font-sans" }, /* @__PURE__ */ import_react.default.createElement(Sidebar, null), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex-1 flex flex-col md:pl-64 p-8" }, /* @__PURE__ */ import_react.default.createElement("h1", { className: "text-3xl font-bold mb-6 text-black" }, "My Feed"), /* @__PURE__ */ import_react.default.createElement(FeedItem, { author: "User A", content: "This is a post from the owner of the Fam." }), /* @__PURE__ */ import_react.default.createElement(FeedItem, { author: "User B", content: "This is a post from me, visible to me." }), /* @__PURE__ */ import_react.default.createElement("div", { className: "text-center py-8 text-gray-500 italic" }, "User C post is hidden (Privacy Check)")));
}
var html = (0, import_server.renderToStaticMarkup)(
  /* @__PURE__ */ import_react.default.createElement("html", null, /* @__PURE__ */ import_react.default.createElement("head", null, /* @__PURE__ */ import_react.default.createElement("script", { src: "https://cdn.tailwindcss.com" })), /* @__PURE__ */ import_react.default.createElement("body", null, /* @__PURE__ */ import_react.default.createElement(Page, null)))
);
console.log(html);
